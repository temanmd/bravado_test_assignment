...
module API
  module V1
    class CarRecommendationsControllerTest < ActionDispatch::IntegrationTest
      test 'get a list of cars' do
        ...
        cars.each_with_index do |car, index|
          ...
          assert_equal expected_hash[index]['rank_score'].to_s,
                       car['rank_score'].to_s
      ...
      test 'get cars by price_min' do
        get api_v1_car_recommendations_path(user_id: 1, price_min: 45_000)
        ...
        assert_empty errors
        cars.each do |car|
          assert car['price'] >= 45_000
        end
      end

      test 'get cars by price_max' do
        get api_v1_car_recommendations_path(user_id: 1, price_max: 14_000)
